...
class Header extends React.Component{
    ...
    render(){
        return (
            ...
            <Navbar color={this.state.color} expand="lg" className={"fixed-top transparent navbar navbar-expand-lg"}>
                <Container fluid>
                        ...
                        <Nav navbar>
                            <NavItem>
                                <Link to="#" className="nav-link">
                                    ...
                                    <p>
                                        <span className="d-lg-none d-md-block">Notificações</span>
                                    </p>
                                </Link>
                            </NavItem> 
                            <Dropdown nav isOpen={this.state.dropdownOpen} toggle={(e) => this.dropdownToggle(e)}>
                                <DropdownToggle caret nav>
                                    ...
                                    <p>
            							<span className="d-lg-none d-md-block">Preferências</span>
            						</p>
                                </DropdownToggle>
                                <DropdownMenu right>
